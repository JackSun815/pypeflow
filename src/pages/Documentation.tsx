      ...
      overview: {
        ...
        sections: [
          ...
          },
          {
                ...
                content: 'The first row of metric cards focuses on your team\'s capacity and targets, providing essential context for understanding performance. These cards display aggregate data across all SDRs and clients, helping you understand your team\'s overall capacity and goals for the month.',
                cardFeatures: [
                  { label: 'Active SDRs', color: 'bg-blue-50 border-blue-200 text-blue-700' },
                  { label: 'Monthly Set Target', color: 'bg-purple-50 border-purple-200 text-purple-700' },
                  { label: 'Monthly Held Target', color: 'bg-indigo-50 border-indigo-200 text-indigo-700' },
                ],
          },
              {
                title: 'Performance and Activity Cards',
                content: 'The second row of cards shifts focus from targets to actual performance, showing you what your team has accomplished. These cards display total meetings booked, meetings held, and pending meetings for the current month, along with progress percentages and cumulative counts. All cards are fully interactive, opening detailed views with comprehensive filtering, sorting, and grouping capabilities that let you analyze the data from multiple perspectives.',
                cardFeatures: [
                  { label: 'Meetings Set', color: 'bg-green-50 border-green-200 text-green-700' },
                  { label: 'Meetings Held', color: 'bg-emerald-50 border-emerald-200 text-emerald-700' },
      ...
      meetings: {
        ...
        sections: [
          ...
          },
          {
                ...
                content: 'Each meeting card is a rich source of information, displaying everything you need to understand that meeting at a glance. The cards show complete contact information, company details, meeting timing, status information, and additional contextual details that provide a comprehensive view of each meeting.',
              ...
              },
              {
                ...
                content: 'As a manager, you have comprehensive editing capabilities that allow you to maintain data accuracy and make necessary updates. You can edit any meeting directly from the meeting card by clicking the edit button, which opens a form where you can modify meeting details including dates, contact information, status, ICP qualification, notes, and timezone. All changes made by managers are immediately reflected in the SDR dashboard, ensuring real-time synchronization across the platform. This instant synchronization means that when managers make corrections or updates, SDRs see those changes immediately, maintaining consistency and ensuring everyone is working with the same information.',
          ...
          },
          {
                ...
                content: 'Managers can update meeting statuses through multiple methods, providing flexibility to match different workflows and preferences. The edit mode allows you to click the edit button and use a status dropdown to change status. Drag and drop functionality (where supported) lets you move meeting cards between status sections. Quick action buttons provide one-click status changes for common updates. When a meeting is marked as "Held", the system uses the scheduled meeting time rather than the current time, ensuring that meeting completion records reflect when meetings actually occurred rather than when they were marked as complete. This accuracy is important for reporting, analysis, and understanding actual meeting patterns.',
        ...
        h1Sections: [
          {
            ...
            sections: [
              ...
              },
              {
                ...
                content: 'To help you find and organize clients efficiently, the interface offers multiple sorting options. You can sort clients alphabetically by name, by target value (highest to lowest), or by date to see the most recently added clients first.',
              },
            ],
          },
          {
            ...
            sections: [
              {
                ...
                content: 'The export functionality in Client Management is designed to give you complete control over your data. When you click the export button, you can export everything—all clients, all assignments, all targets, and all performance metrics—into a spreadsheet format. The export feature offers extensive customization options that let you select exactly which columns and data points you want to include. This means you can create exports tailored to specific reporting needs, whether you\'re preparing a summary for stakeholders, analyzing performance trends, or planning for upcoming months.',
            ...
            sections: [
              {
                ...
                cardFeatures: [
                  ...
                  { label: 'Client', color: 'bg-green-50 border-green-200 text-green-700' },
                ],
          ...
          },
          {
            ...
            sections: [
              ...
              },
              {
                ...
                content: 'When you need to add a new manager to your agency, the process is straightforward. You\'ll provide the manager\'s email address, which serves as their login credential, along with their full name for identification purposes. You\'ll also set an initial password for the account, which must be at least 6 characters long. Once created, the manager immediately has full access to the system and can begin managing users, viewing dashboards, and performing all administrative functions. The interface displays all managers in your agency, showing their email addresses, names, and account status, allowing you to maintain oversight of your administrative team.',
              },
            ],
          },
          {
        ...
        sections: [
          {
              ...
              },
              {
                ...
                content: 'Each meeting card shows all relevant information needed for ICP review, including contact details, company information, meeting details, client assignment, and any existing notes.',
              },
            ],
          },
          {
            ...
            sections: [
              {
                ...
                content: 'Meetings are tracked with ICP status including Pending (awaiting review), Approved (meets ICP criteria), and Denied (does not meet ICP criteria).',
              },
              {
                title: 'Audit Trail',
          ...
          },
          {
            ...
            sections: [
              ...
              },
              {
                ...
                content: 'The Meeting History page includes comprehensive filtering, sorting, and grouping functions that help you find and analyze specific meetings. You can filter by client name to focus on specific accounts, helping you understand your performance with individual clients over time. Sorting options let you organize meetings by date, by client, or by contact name. You can choose ascending or descending order depending on your analytical needs. Grouping options let you organize meetings by client to see all meetings for each account together, or leave them ungrouped for a pure chronological view.',
